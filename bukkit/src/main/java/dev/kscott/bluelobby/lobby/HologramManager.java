...
//        hologram.appendTextLine(BungeeComponentSerializer.builder().useUnusualXRepeatedCharacterHexFormat().build());
        hologram.appendTextLine(TextComponent.toLegacyText(BungeeComponentSerializer.legacy().serialize(Constants.Chat.SERVER_NAME)));
        hologram.appendTextLine(TextComponent.toLegacyText(BungeeComponentSerializer.legacy().serialize(Component.text().append(Component.text("by")).append(Constants.Chat.SERVER_NAME).asComponent())));
