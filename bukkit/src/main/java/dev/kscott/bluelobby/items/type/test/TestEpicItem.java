...
public class TestEpicItem implements Item, Tiered {
    @Override
    ...
    public @NonNull List<Effect> effects() {
        return List.of(
                new PositiveEffect(List.of(Component.text("A positive test."), Component.text("multine test"))),
                new NeutralEffect(List.of(Component.text("A neutral test."), Component.text("A neutral test."))),
                new NegativeEffect(List.of(Component.text("A negative test."), Component.text("A negative test."))),
                new SpecialEffect(List.of(Component.text("A special test."), Component.text("A special test.")))
        );
    }
